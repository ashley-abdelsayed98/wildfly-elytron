...
public interface ElytronToolMessages extends BasicLogger {
    ...
    @Message(id = NONE, value = "The directory containing the known SSH hosts.")
    String cmdLineSshDirectoryDesc();

    @Message(id = NONE, value = "The name of the file containing the known SSH hosts.")
    String cmdLineKnownHostsFileDesc();
